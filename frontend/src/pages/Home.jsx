    ...
    <div className="relative w-screen flex flex-col items-center bg-[#f0f4ff] text-white overflow-hidden overflow-y-auto pb-24 min-h-screen">
      ...
      <div className="relative z-10 w-full flex items-start justify-between px-5 pt-5">
        <div className="flex flex-col">
          <p className="text-xs font-light text-white/70 tracking-wide">Welcome back 👋</p>
      ...
      <div className="w-[90%] flex flex-col gap-3">
        ...
        >
          <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between", px: 2.5, py: 2.25 }}>
            <Box sx={{ display: "flex", alignItems: "center", gap: 1.75 }}>
              ...
              <Box sx={{ textAlign: "left" }}>
                <Typography sx={{ fontSize: 14, fontWeight: 800, color: "white", lineHeight: 1.2, letterSpacing: "-0.01em" }}>
            ...
            <Box sx={{
              ...
              <Typography sx={{ fontSize: 18, color: "white", lineHeight: 1 }}>→</Typography>
            </Box>
          </Box>
        </motion.button>
          ...
          <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between", px: 2.5, py: 2.25 }}>
            <Box sx={{ display: "flex", alignItems: "center", gap: 1.75 }}>
              <Box sx={{
                ...
                <TrackChangesRoundedIcon sx={{ color: "#2563eb", fontSize: 22 }} />
              </Box>
              <Box sx={{ textAlign: "left" }}>
                <Typography sx={{ fontSize: 14, fontWeight: 800, color: "#1e293b", lineHeight: 1.2, letterSpacing: "-0.01em" }}>
            ...
            <Box sx={{
              ...
              <Typography sx={{ fontSize: 18, color: "#2563eb", lineHeight: 1 }}>→</Typography>
            </Box>
          </Box>
        </motion.button>
